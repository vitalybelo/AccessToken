...
/**
 * Авторизационный класс для получения токена доступа, с помощью которого можно выполнять
 * например http запросы в другой сервис. В классе всего два метода, первый возвращает свежий токен
 * доступа, второй - возвращает заголовок http запроса Oauth2, необходимый для выполнения запроса.
 *
...
public class KeycloakTokenService {
    ...
    /**
     * Метод запрашивает токен доступа в административной консоли keycloak, а после получения
